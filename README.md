...
The fork starts at v3.0.0, though aside removing a lot of stuff, nothing internally has changed. The major version bump is purely to separate this fork from the ensloppified upstream's versioning.
